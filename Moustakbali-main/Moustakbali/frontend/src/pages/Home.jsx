  ...
  return (
    <div className="min-h-screen pt-4 px-4 md:px-8 relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto min-h-[90vh] md:min-h-[100vh] flex flex-col justify-center items-center overflow-visible mb-0 pt-16 md:pt-16">
        ...
        <div className="relative w-full z-30 mt-10 md:mt-20 flex flex-col items-center px-4">
          ...
          <div className="absolute -bottom-24 md:-bottom-32 left-1/2 -translate-x-1/2 w-[200%] h-[300px] md:h-[400px] overflow-hidden pointer-events-none opacity-40 md:opacity-60">
             <div 
               className="w-full h-full bg-gradient-to-t from-white/10 to-transparent"
               style={{ clipPath: 'polygon(50% 0%, 0% 100%, 100% 100%)' }}
             />
             <div 
               className="absolute inset-0 w-full h-full bg-gradient-to-t from-green-main to-transparent opacity-80"
               style={{ clipPath: 'polygon(50% 0%, 0% 100%, 100% 100%)' }}
             />
          </div>
        </div>
            ...
            <div className="p-4 md:p-8 flex flex-col md:flex-row items-center gap-12">
              ...
              <div className="w-full md:w-2/3 aspect-video bg-white/5 rounded-3xl overflow-hidden relative border border-white/10">
                <iframe 
                  ...
                  src="https://www.youtube.com/embed/4G4qNkkoHuY?autoplay=0&controls=1&rel=0" 
      ...
      <div className="max-w-7xl mx-auto py-16 border-t border-white/10">
        <div className="bg-gradient-to-br from-[#0a0a0a] to-[#041a10] relative overflow-hidden rounded-3xl p-10 md:p-16 shadow-2xl flex flex-col md:flex-row items-center justify-between border border-white/20">
      ...
      <div className="max-w-7xl mx-auto py-32 px-4 border-t border-border mt-32">
        ...
        <div className="flex justify-center">
          <motion.div 
            whileHover={{ y: -10 }}
            className="w-full max-w-lg bg-gradient-to-br from-[#0a0a0a] to-[#061f14] border-2 border-white/20 hover:border-white/40 transition-colors rounded-[2.5rem] p-12 relative overflow-hidden shadow-[0_0_50px_rgba(255,255,255,0.05)]"
          >
      ...
      <div className="w-full py-20 overflow-hidden bg-bg-primary border-t border-border mt-16 relative">
        
        <div className="text-center mb-12 relative z-20">
          <h2 className="text-3xl md:text-4xl font-syne font-bold text-white mb-4 uppercase tracking-tighter">
            Notre <span className="text-green-bright">Galerie</span>
          </h2>
          <p className="text-gray-400 font-medium">Une vision d'avenir en images.</p>
        </div>
        ...
        <div className="relative flex whitespace-nowrap overflow-hidden">
          ...
          >
            ...
            {[
              ...
              <div 
                key={i} 
                className="w-64 md:w-80 aspect-[1/1.414] shrink-0 rounded-2xl overflow-hidden border border-white/10 shadow-2xl relative group"
              >
